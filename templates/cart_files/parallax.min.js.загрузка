...
<html lang="en" style="height: 100%">
    <head>
        ...
        <script type="text/javascript">
            var Anywhere = {};
            Anywhere.urls = {};
            Anywhere.csrfToken = "kUeP6eF5rPtvTd2P9fhcav1R8UDWydYFqc2nHaZE0eAoZFBryfG9nJEZ04bzRP6d";
        </script>
...
<li class="visible-xs"><a href="https://blog.pythonanywhere.com/" target="_parent" class="blog_link">Blog</a></li>
  ...
  <form class="form" action="" method="post"><input type="hidden" name="csrfmiddlewaretoken" value="kUeP6eF5rPtvTd2P9fhcav1R8UDWydYFqc2nHaZE0eAoZFBryfG9nJEZ04bzRP6d">
    <table>

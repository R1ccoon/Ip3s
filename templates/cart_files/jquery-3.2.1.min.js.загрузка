...
<html lang="en" style="height: 100%">
    <head>
        ...
        <script type="text/javascript">
            var Anywhere = {};
            Anywhere.urls = {};
            Anywhere.csrfToken = "omIS4PrkMKQh6nETvF1fnUctW3o1DIscZwJxD7G7y6ljsLAM4a6QCAEgEyrbYUxz";
        </script>
...
<li class="visible-xs"><a href="https://blog.pythonanywhere.com/" target="_parent" class="blog_link">Blog</a></li>
  ...
  <form class="form" action="" method="post"><input type="hidden" name="csrfmiddlewaretoken" value="omIS4PrkMKQh6nETvF1fnUctW3o1DIscZwJxD7G7y6ljsLAM4a6QCAEgEyrbYUxz">
    <table>
